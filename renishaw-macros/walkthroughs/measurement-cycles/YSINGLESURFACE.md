# O6005 - YSINGLESURFACE

## Purpose
Brief: This macro supports **ysinglesurface** on the Smart Machine Tool MINI using a Fanuc 0i-MF control.
...
| --- | --- | --- |
| 1 | `2: <YSINGLESURFACE>(O6005)` | Shop-level wrapper declaration for this cycle. |
| 2 | `3: (SMART MACHINE TOOL MINI / FANUC 0I-MF)` | Comment/documentation line: SMART MACHINE TOOL MINI / FANUC 0I MF. |
| 3 | `4: (PURPOSE: YSINGLESURFACE)` | Comment/documentation line: PURPOSE: YSINGLESURFACE. |
| 4 | `5: (DETAILS: walkthroughs/measurement-cycles/YSINGLESURFACE.md)` | Comment/documentation line: DETAILS: walkthroughs/measurement cycles/YSINGLESURFACE.md. |
...
| 10 | `11: G0G90G54X0.0Y0.0` | Rapid positioning move. Sets absolute positioning mode. |
| 11 | `12: G43Z200.0H1` | Applies tool length compensation. |
...
| 20 | `21: G65P9810Y0.0` | Calls macro O9810 (REN PROTECTED POSN) with the supplied arguments. |
...
| 24 | `25: G65P9811Y31.S3` | Calls macro O9811 (REN X/Y/Z MEASURE) with the supplied arguments. |
...
| 31 | `33: (PROBE OFF)` | Comment/documentation line: PROBE OFF. |
| 32 | `34: G04X1.` | Executes macro-specific calculation or control logic. |
| 33 | `35: G91G28Z0.` | Sets incremental positioning mode. Returns axis/axes toward machine reference position. |
| 34 | `36: (END PROGRAM)` | Comment/documentation line: END PROGRAM. |
| 35 | `37: M30` | End of program and rewind/reset. |
