# O6003 - ZSINGLESURFACE

## Purpose
Brief: This macro supports **zsinglesurface** on the Smart Machine Tool MINI using a Fanuc 0i-MF control.
...
| --- | --- | --- |
| 1 | `2: <ZSINGLESURFACE>(O6003)` | Shop-level wrapper declaration for this cycle. |
| 2 | `3: (SMART MACHINE TOOL MINI / FANUC 0I-MF)` | Comment/documentation line: SMART MACHINE TOOL MINI / FANUC 0I MF. |
| 3 | `4: (PURPOSE: ZSINGLESURFACE)` | Comment/documentation line: PURPOSE: ZSINGLESURFACE. |
| 4 | `5: (DETAILS: walkthroughs/measurement-cycles/ZSINGLESURFACE.md)` | Comment/documentation line: DETAILS: walkthroughs/measurement cycles/ZSINGLESURFACE.md. |
...
| 10 | `11: G0G90G54X40.Y0.` | Rapid positioning move. Sets absolute positioning mode. |
...
| 19 | `20: (CALL O9811 (REN X/Y/Z MEASURE))` | Executes macro-specific calculation or control logic. |
| 20 | `21: G65P9811Z0.S2` | Calls macro O9811 (REN X/Y/Z MEASURE) with the supplied arguments. |
...
| 27 | `28: G04X1.` | Executes macro-specific calculation or control logic. |
| 28 | `29: G91G28Z0.` | Sets incremental positioning mode. Returns axis/axes toward machine reference position. |
| 29 | `30: (CALL O9833 (REN PROBE STOP))` | Executes macro-specific calculation or control logic. |
| 30 | `31: G65P9833` | Calls macro O9833 (REN PROBE STOP) with the supplied arguments. |
| 31 | `32: (END PROGRAM)` | Comment/documentation line: END PROGRAM. |
| 32 | `33: M30` | End of program and rewind/reset. |
